...
const WriterChatBotPage = () => {
    ...
    const handleSendMessage = async (message: string) => {
        if (message.length > 0) {
            ...
            const response = await runWriterChat(message, history);
        ...
        <Card className="m-5 h-[calc(100dvh-105px)] border border-divider shadow-sm dark:bg-gray-900">
            ...
            <CardFooter className="shrink-0 grow">
                <div className="flex w-full items-end gap-3">
                    ...
                    <PromptsModal title="Writing Prompts" category="Writing" setMessage={setMessage} />
...
export default WriterChatBotPage;
