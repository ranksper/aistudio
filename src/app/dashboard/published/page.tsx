...
const DashboardPublishedPage = () => {
    ...
    const loadData = async (limit: number, offset: number) => {
        setLoading(true);
        const response = await getPromptsByStatus("published", limit, offset, user?.$id);
...
export default DashboardPublishedPage;
